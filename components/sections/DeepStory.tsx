...
const storyItems = [
  ...
  },
  {
    ...
    year: '2018',
    content:
      'その高校に入学して最初に感じたのは、生徒も教師も「勉強が全て」といった感じでした。当時の僕は「勉強よりももっと大切なものがあるだろ」と反骨心を抱き、一切勉強せず最下位という称号を取得しました。それを機に教育指導の強面教師がある授業で「大野お前ちゃんとやれや」と激怒した際に、「先生の授業はわかりづらいので自分でやってTOP10入ります」と宣言し、実際に7位を取ることができました。こうして振り返ると、反骨心に溢れる学生時代だったのかもしれません。とはいっても、基本的に周りが皆頭が良かったので、自分がちゃんとしなくてもみんながなんとかしてくれる精神で楽観的に生きてました。',
  },
  {
    title: '大学→中退',
    year: '2020',
  ...
  },
  {
    ...
    year: '2023',
    content:
      '働いて 1年が過ぎたころ、自分にはある葛藤がありました。店舗型のBtoCビジネスが主軸であったので毎日の繰り返し業務のようなものも多く、店舗を運営する上でもチームビルディングの観点でもその繰り返しの業務が大切なことは理解していましたが、自分はもっと早く売上を上げる力や成果を出さないといけないと焦っていました。ここで毎日接客しているような時間があるなら、自分で事業をしたい、それか経営で困っている人、本気で人生を頑張っている誰かの力になりたいとそう思っていました。そこで苦渋の決断でしたが、辞めることを伝え、当時リファラルで声のかかっていたコンサル会社へ入社することを決めました。',
  },
  {
    title: '株式会社Arinos→倒産',
    year: '2023',
